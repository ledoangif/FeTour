...
import { ref, watch, mergeProps, withCtx, renderSlot, openBlock, createBlock, createTextVNode, createCommentVNode, unref, createVNode, withDirectives, Fragment, renderList, toDisplayString, vModelSelect, useSSRContext, onMounted } from "vue";
            ...
            return [
              __props.isEditMode ? (openBlock(), createBlock("span", { key: 0 }, [
                renderSlot(_ctx.$slots, "header", {}, () => [
                  createTextVNode("Cập nhật khách hàng")
                ])
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Form), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="row"${_scopeId2}><div class="row col-lg-6 mb-3 form-group required"${_scopeId2}><div class="row mb-3 form-group required"${_scopeId2}><label for="source-name" class="col-sm-4 col-form-label control-label text-end"${_scopeId2}> Tên khách hàng </label><div class="col-sm-8"${_scopeId2}>`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CVModal, mergeProps({ id_model: "deleteCustomerModal" }, _attrs), {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "header", {}, () => {
              _push2(`Xóa khách hàng này`);
            }, _push2, _parent2, _scopeId);
          } else {
            return [
              renderSlot(_ctx.$slots, "header", {}, () => [
                createTextVNode("Xóa khách hàng này")
              ])
            ];
          }
        }),
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Bạn có chắc chắn muốn xóa khách hàng này?</p><div class="modal-footer align-content-center justify-content-center"${_scopeId}><button type="button" class="btn btn-secondary" data-bs-dismiss="modal"${_scopeId}> Hủy bỏ </button><button type="button" class="btn btn-danger"${_scopeId}> Xóa </button></div>`);
          } else {
            return [
              createVNode("p", null, "Bạn có chắc chắn muốn xóa khách hàng này?"),
              createVNode("div", { class: "modal-footer align-content-center justify-content-center" }, [
                createVNode("button", {
                  type: "button",
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><table class="table text-center table-hover table-success table-striped-columns"><thead class="table-primary table-active"><tr><th scope="col">No.</th><th colspan="2">Thông tin khách hàng</th><th colspan="2">Thông tin liên lạc</th><th scope="col">Địa chỉ</th><th colspan="2">Thông tin thanh toán</th><th scope="col">Tác vụ</th></tr></thead><tbody><!--[-->`);
...
//# sourceMappingURL=index-Dsbs_Ojj.js.map
