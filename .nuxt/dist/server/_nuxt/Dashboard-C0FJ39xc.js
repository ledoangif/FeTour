...
import { version as version$1, defineComponent, ref, shallowRef, onUnmounted, watch, toRaw, nextTick, h, isProxy, withAsyncContext, unref, useSSRContext, computed, mergeProps, withCtx, createVNode } from "vue";
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h3 class="text-danger text-center my-3" data-v-b338afd8>THỐNG KÊ SỐ LIỆU </h3><div class="d-flex flex-row text-center" data-v-b338afd8><div class="col-12" data-v-b338afd8><div class="d-flex flex-row justify-content-between ms-5 mb-3" data-v-b338afd8><div class="fs-4" data-v-b338afd8><span class="text-primary fw-bold" data-v-b338afd8>Tổng số tour:</span> ${ssrInterpolate(props.totalTour)}</div><div class="fs-4" data-v-b338afd8><span class="text-primary fw-bold" data-v-b338afd8>Tổng số khách sạn:</span> ${ssrInterpolate(props.totalHotel)}</div><div class="fs-4" data-v-b338afd8><span class="text-primary fw-bold" data-v-b338afd8>Tổng số khách hàng:</span> ${ssrInterpolate(props.totalcustomer)}</div></div><table class="table text-center table-hover" data-v-b338afd8><thead class="table-active table-primary" data-v-b338afd8><tr data-v-b338afd8><!--[-->`);
      ssrRenderList(12, (month) => {
        _push(`<th scope="col" data-v-b338afd8>Tháng ${ssrInterpolate(month)}</th>`);
      });
      ...
      _push(`<!--]--></tr></tbody></table></div></div><h4 class="text-danger text-center my-3" data-v-b338afd8>Doanh số đặt tour so với cung kì năm ngoái</h4><div class="row" data-v-b338afd8><div class="d-flex flex-row" data-v-b338afd8><div class="line-chart-container col-8" data-v-b338afd8>`);
...
//# sourceMappingURL=Dashboard-C0FJ39xc.js.map
