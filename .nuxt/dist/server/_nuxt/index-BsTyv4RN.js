...
import { ref, watch, mergeProps, withCtx, renderSlot, openBlock, createBlock, createTextVNode, unref, createVNode, useSSRContext } from "vue";
          ...
          if (_push2) {
            if (!__props.isEditMode) {
              ...
              ssrRenderSlot(_ctx.$slots, "header", {}, () => {
                _push2(`Thêm khách sạn`);
              }, _push2, _parent2, _scopeId);
              _push2(`</span>`);
            } else {
              _push2(`<span${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, "header", {}, () => {
                _push2(`Cập nhật khách sạn`);
              }, _push2, _parent2, _scopeId);
              _push2(`</span>`);
            }
          } else {
            return [
              !__props.isEditMode ? (openBlock(), createBlock("span", { key: 0 }, [
                renderSlot(_ctx.$slots, "header", {}, () => [
                  createTextVNode("Thêm khách sạn")
                ])
              ])) : (openBlock(), createBlock("span", { key: 1 }, [
                renderSlot(_ctx.$slots, "header", {}, () => [
                  createTextVNode("Cập nhật khách sạn")
                ])
              ]))
            ];
          }
          ...
          if (_push2) {
            _push2(ssrRenderComponent(unref(Form), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="row"${_scopeId2}><div class="row col-lg-8 mb-3 form-group required"${_scopeId2}><div class="row mb-3 form-group required"${_scopeId2}><label for="source-name" class="col-sm-4 col-form-label control-label text-end"${_scopeId2}> Tên khách sạn </label><div class="col-sm-8"${_scopeId2}>`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CVModal, mergeProps({ id_model: "deleteHotelModal" }, _attrs), {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "header", {}, () => {
              _push2(`Xóa khách sạn này`);
            }, _push2, _parent2, _scopeId);
          } else {
            return [
              renderSlot(_ctx.$slots, "header", {}, () => [
                createTextVNode("Xóa khách sạn này")
              ])
            ];
          }
        }),
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p${_scopeId}>Bạn có chắc chắn muốn xóa khách sạn này?</p><div class="modal-footer align-content-center justify-content-center"${_scopeId}><button type="button" class="btn btn-secondary" data-bs-dismiss="modal"${_scopeId}> Hủy bỏ </button><button type="button" class="btn btn-danger"${_scopeId}> Xóa </button></div>`);
          } else {
            return [
              createVNode("p", null, "Bạn có chắc chắn muốn xóa khách sạn này?"),
              createVNode("div", { class: "modal-footer align-content-center justify-content-center" }, [
                createVNode("button", {
                  type: "button",
...
//# sourceMappingURL=index-BsTyv4RN.js.map
